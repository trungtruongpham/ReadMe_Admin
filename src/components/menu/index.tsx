...
export default function Menu() {
  return (
    <>
      <div id="menu" className="w-[200px] h-vh min-h-screen bg-slate-100 pt-8 ">
        ...
        <div
          id="menu-section"
          className="flex flex-col pt-8 m-auto max-w-[150px] space-y-2"
        >
          <Link
            to={"/home/dashboard"}
          ...
          >
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="relative top-1 w-6 h-6 mr-2"
            >
              <path
                strokeLinecap="round"
