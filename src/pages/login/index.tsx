          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">
                Unleash your literary kingdom with our admin site. A realm of
                words, where you reign supreme. Manage, organize, and bring
                stories to life with ease. Your bookish empire awaits.
              </p>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    {(errors.password || errors.username) && (
                      <span className="my-4 bg-red-500 rounded p-2">
